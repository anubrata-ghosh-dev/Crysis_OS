...
export default function IntelligenceFeed({ alerts, onAlertSelect }: IntelligenceFeedProps) {
  return (
    <div className="w-full h-full flex flex-col bg-transparent">
      {/* Header */}
      <div className="border-b border-crisis-edge px-5 py-4 bg-black/30 backdrop-blur-xl flex-shrink-0">
        <h2 className="text-xs font-black text-crisis-cyan tracking-widest uppercase letter-spacing-wide">ACTIVE INCIDENTS</h2>
        <p className="text-xs text-gray-400 mt-2">• {alerts.length} incidents detected</p>
      </div>
